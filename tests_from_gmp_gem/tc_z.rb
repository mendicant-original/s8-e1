...
class TC_Z < Test::Unit::TestCase
  ...
  def test_divisible_ui
    ...
    a_factors.each do |d|
      assert(a.divisible?(d), "GMP::Z#divisible? ui should be true: #{a}.divisible? #{d}")
    end
  ...
  def test_divisible_bignum
    ...
    a_factors.each do |d|
      assert(a.divisible?(d), "GMP::Z#divisible? bignum should be true: #{a}.divisible? #{d}")
    end
  ...
  def test_divisible_z
    ...
    a_factors.each do |d|
      assert(a.divisible?(d), "GMP::Z#divisible? GMP::Z should be true: #{a}.divisible? #{d}")
    end
